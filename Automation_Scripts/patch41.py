...
# Delete the old failed code if we added it (by finding it and removing it, but wait! The previous compile failed, so it's still in the file!)
import re
