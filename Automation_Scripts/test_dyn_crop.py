...
if hwnd:
    ...
    left = point.x
    top = point.y
    right = point.x + rect.right
    bottom = point.y + rect.bottom
    
    screen = ImageGrab.grab(bbox=(left, top, right, bottom))
    screen.save(r'C:\Users\l3d\.gemini\antigravity\brain\2d7a8410-35e6-47b7-a5c1-e3ce6a91a404\AVBOIT_Fixed_Screen_Cropped.png')
